...
public interface ProductRepository extends JpaRepository<Product, String> {
    ...
    @Query("SELECT p FROM Product p WHERE p.productCode LIKE :productCodePrefix%")
    List<Product> findProductsByCode(@Param("productCodePrefix") String productCodePrefix);
